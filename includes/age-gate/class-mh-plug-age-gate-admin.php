...
class MH_Plug_Age_Gate_Admin {
            ...
            <form method="post" action="options.php">
                ...
                <div class="mh-accordion">
                    ...
                    <div class="mh-accordion-item">
                        ...
                        <div class="mh-accordion-content">
                            <div class="mh-settings-grid" id="mh-appearance-grid">
                                <?php
    ...
    public function sanitize( $input ) {
        ...
        $sanitary_values['show_logo']       = isset( $input['show_logo'] ) && $input['show_logo'] == '1' ? true : false;
        ...
        $text_fields = array( 'modal_heading', 'btn_yes_text', 'btn_no_text' );
        ...
        $color_fields = array( 'overlay_bg_color', 'bg_color', 'title_color', 'text_color', 'btn_yes_bg_color', 'btn_yes_hover_color', 'btn_yes_text_color', 'btn_no_bg_color', 'btn_no_hover_color', 'btn_no_text_color' );
