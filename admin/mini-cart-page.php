...
<div class="wrap mh-plug-admin-wrap">
    ...
    <div class="mh-tb-header">
        <div class="mh-tb-header-text">
            <h1 class="mh-plug-title"><?php esc_html_e( 'Mini Cart Settings', 'mh-plug' ); ?></h1>
            <p class="mh-tb-description"><?php esc_html_e( 'Configure the off-canvas sidebar panel that appears on your storefront.', 'mh-plug' ); ?></p>
        </div>
    </div>
        ...
        <div class="mh-accordion">
            ...
            <div class="mh-accordion-item mh-active">
                <div class="mh-accordion-header">
                    <span class="mh-accordion-title"><?php esc_html_e( 'General', 'mh-plug' ); ?></span>
                ...
                <div class="mh-accordion-content" style="display:block;">
                    <div class="mh-settings-grid" style="max-width:600px;">
                        ...
                        <div class="mh-form-group">
                            <label class="mh-form-label"><?php esc_html_e( 'Enable Off-Canvas Mini Cart', 'mh-plug' ); ?></label>
                        ...
                        <div class="mh-form-group">
                            <label class="mh-form-label"><?php esc_html_e( 'Cart Page URL', 'mh-plug' ); ?></label>
                            <div class="mh-form-field-control">
                                ...
                                <p class="description"><?php esc_html_e( 'Leave empty to use the default WooCommerce cart page URL.', 'mh-plug' ); ?></p>
                            </div>
                        </div>

                        <div class="mh-form-group">
                            <label class="mh-form-label"><?php esc_html_e( 'Checkout Page URL', 'mh-plug' ); ?></label>
                            <div class="mh-form-field-control">
                                ...
                                <p class="description"><?php esc_html_e( 'Leave empty to use the default WooCommerce checkout page URL.', 'mh-plug' ); ?></p>
                            </div>
                        </div>
            ...
            <div class="mh-accordion-item">
                <div class="mh-accordion-header">
                    <span class="mh-accordion-title"><?php esc_html_e( 'Sidebar Panel', 'mh-plug' ); ?></span>
                    <span class="mh-accordion-icon">+</span>
                </div>
                <div class="mh-accordion-content">
                    <div class="mh-settings-grid" style="max-width:600px;">
                        ...
                        <div class="mh-form-group">
                            <label class="mh-form-label"><?php esc_html_e( 'Panel Background', 'mh-plug' ); ?></label>
                            <div class="mh-form-field-control">
                        ...
                        <div class="mh-form-group">
                            <label class="mh-form-label"><?php esc_html_e( 'Panel Text Color', 'mh-plug' ); ?></label>
                            <div class="mh-form-field-control">
                        ...
                        <div class="mh-form-group">
                            <label class="mh-form-label"><?php esc_html_e( 'Panel Width (px)', 'mh-plug' ); ?></label>
                            <div class="mh-form-field-control">
            ...
            <div class="mh-accordion-item">
                <div class="mh-accordion-header">
                    <span class="mh-accordion-title"><?php esc_html_e( 'Button Styles', 'mh-plug' ); ?></span>
                    <span class="mh-accordion-icon">+</span>
                </div>
                <div class="mh-accordion-content">
                    <div class="mh-settings-grid" style="max-width:600px;">
                        ...
                        <div class="mh-form-group">
                            <label class="mh-form-label"><?php esc_html_e( 'Button Border Radius (px)', 'mh-plug' ); ?></label>
                            <div class="mh-form-field-control">
                        ...
                        <h3 style="margin:20px 0 5px; color:#004265;"><?php esc_html_e( '"View Cart" Button', 'mh-plug' ); ?></h3>

                        <div class="mh-form-group">
                            <label class="mh-form-label"><?php esc_html_e( 'Background Color', 'mh-plug' ); ?></label>
                            <div class="mh-form-field-control">
                        ...
                        <div class="mh-form-group">
                            <label class="mh-form-label"><?php esc_html_e( 'Text Color', 'mh-plug' ); ?></label>
                            <div class="mh-form-field-control">
                        ...
                        <h3 style="margin:20px 0 5px; color:#004265;"><?php esc_html_e( '"Checkout" Button', 'mh-plug' ); ?></h3>
