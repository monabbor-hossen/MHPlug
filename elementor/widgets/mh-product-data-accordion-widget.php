...
class MH_Product_Data_Accordion_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control( 'table_padding', [
            ...
            'selectors'  => [ '{{WRAPPER}} .woocommerce-product-attributes th, {{WRAPPER}} .woocommerce-product-attributes td' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};', ],
        ] );
    ...
    protected function render() {
        ...
        if ( $layout === 'accordion' ) {
            ...
            ?>
                ...
                .mh-accordion-content .woocommerce-product-attributes td { text-align: left; }
                .mh-accordion-content .woocommerce-product-attributes th { width: 40%; }
                .mh-accordion-content p:last-child { margin-bottom: 0; }
            <?php
            $css = ob_get_clean();
            wp_register_style( 'mh-product-data-style', false );
            wp_enqueue_style( 'mh-product-data-style' );
            wp_add_inline_style( 'mh-product-data-style', $css );
            ?>
        ...
        // ==========================================
            ...
            ?>
                ...
                .mh-tabs-container-<?php echo esc_attr( $widget_id ); ?> .woocommerce-product-attributes td { text-align: left; }
                .mh-tabs-container-<?php echo esc_attr( $widget_id ); ?> .woocommerce-product-attributes th { width: 30%; }
