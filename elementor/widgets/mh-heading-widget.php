...
class MH_Heading_Widget extends Widget_Base {
    ...
    protected function register_controls() {
        ...
        $repeater->add_control( 'part_display_mode', [ 'label' => esc_html__('Text Layout', 'mh-plug'), 'type' => Controls_Manager::SELECT, 'options' => [ 'inline-block' => esc_html__('Inline (Next to each other)', 'mh-plug'), 'block' => esc_html__('Block (Force New Line)', 'mh-plug'), 'vertical' => esc_html__('Vertical Text (Rotated)', 'mh-plug'), ], 'default' => 'inline-block', ] );
