...
class MH_Plug_Product_Tags_Widget extends \Elementor\Widget_Base {

    public function get_name() { return 'mh_product_tags'; }
    public function get_title() { return __( 'MH Product Tags', 'mh-plug-ecommerce-builder-widgets' ); }
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section( 'content_section', [
            'label' => __( 'Tags Settings', 'mh-plug-ecommerce-builder-widgets' ),
        ...
        $this->add_control( 'prefix_text', [
            ...
            'default'     => __( 'Tags: ', 'mh-plug-ecommerce-builder-widgets' ),
            'placeholder' => __( 'e.g. Tags:', 'mh-plug-ecommerce-builder-widgets' ),
        ...
        $this->add_responsive_control( 'prefix_spacing', [
            'label'      => __( 'Spacing (Distance to tags)', 'mh-plug-ecommerce-builder-widgets' ),
        ...
        $this->start_controls_section( 'style_links_section', [
            'label' => __( 'Tag Links Style', 'mh-plug-ecommerce-builder-widgets' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );
