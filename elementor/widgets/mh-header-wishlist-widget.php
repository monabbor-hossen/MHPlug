...
class MH_Plug_Header_Wishlist_Widget extends \Elementor\Widget_Base {

    public function get_name() { return 'mh_header_wishlist'; }
    public function get_title() { return __( 'MH Header Wishlist', 'mh-plug-ecommerce-builder-widgets' ); }
    ...
    protected function register_controls() {
        $this->start_controls_section( 'section_style_icon', [ 'label' => __( 'Icon & Layout', 'mh-plug-ecommerce-builder-widgets' ), 'tab' => Controls_Manager::TAB_STYLE ] );

        $this->add_responsive_control( 'align', [
            'label' => __( 'Alignment', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::CHOOSE,
        ...
        $this->add_responsive_control( 'icon_size', [
            'label' => __( 'Size', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::SLIDER, 'size_units' => [ 'px' ], 'range' => [ 'px' => [ 'min' => 10, 'max' => 100 ] ], 'default' => [ 'size' => 24 ],
            'selectors' => [ '{{WRAPPER}} .mh-wishlist-action i' => 'font-size: {{SIZE}}{{UNIT}};' ],
        ] );

        $this->add_control( 'icon_color', [
            'label' => __( 'Color', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#333333',
            'selectors' => [ '{{WRAPPER}} .mh-wishlist-action i' => 'color: {{VALUE}};' ],
        ] );

        $this->add_control( 'icon_hover_color', [
            'label' => __( 'Hover Color', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#d63638',
            'selectors' => [ '{{WRAPPER}} .mh-wishlist-action:hover i' => 'color: {{VALUE}};' ],
        ] );

        $this->end_controls_section();

        $this->start_controls_section( 'section_style_badge', [ 'label' => __( 'Notification Badge', 'mh-plug-ecommerce-builder-widgets' ), 'tab' => Controls_Manager::TAB_STYLE ] );

        $this->add_control( 'badge_bg_color', [
            'label' => __( 'Background Color', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#d63638',
            'selectors' => [ '{{WRAPPER}} .mh-action-badge' => 'background-color: {{VALUE}};' ],
        ] );

        $this->add_control( 'badge_text_color', [
            'label' => __( 'Text Color', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#ffffff',
        ...
        $this->add_responsive_control( 'badge_size', [
            'label' => __( 'Badge Size', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::SLIDER, 'default' => [ 'size' => 18 ],
        ...
        $this->add_responsive_control( 'badge_offset_x', [
            'label' => __( 'Horizontal Offset', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::SLIDER, 'range' => [ 'px' => [ 'min' => -20, 'max' => 20 ] ], 'default' => [ 'size' => -8 ],
            'selectors' => [ '{{WRAPPER}} .mh-action-badge' => 'right: {{SIZE}}px;' ],
        ] );

        $this->add_responsive_control( 'badge_offset_y', [
            'label' => __( 'Vertical Offset', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::SLIDER, 'range' => [ 'px' => [ 'min' => -20, 'max' => 20 ] ], 'default' => [ 'size' => -8 ],
