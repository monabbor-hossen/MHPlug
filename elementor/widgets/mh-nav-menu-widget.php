...
class MH_Nav_Menu_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_responsive_control( 'main_color', [
        ...
        $this->add_responsive_control( 'main_color_hover', [
            'label' => 'Text Color', 'type' => Controls_Manager::COLOR,
            'selectors' => [ '{{WRAPPER}} .mh-menu > li > a:hover' => 'color: {{VALUE}} !important;' ],
        ] );
        $this->add_responsive_control( 'main_bg_hover', [
            'label' => 'Background Color', 'type' => Controls_Manager::COLOR,
        ...
        $this->add_responsive_control( 'main_pointer_color', [
        ...
        $this->add_responsive_control( 'main_color_active', [
            'label' => 'Text Color', 'type' => Controls_Manager::COLOR,
            'selectors' => [ '{{WRAPPER}} .mh-menu > li.current-menu-item > a' => 'color: {{VALUE}} !important;' ],
        ] );
        $this->add_responsive_control( 'main_bg_active', [
            'label' => 'Background Color', 'type' => Controls_Manager::COLOR,
        ...
        $this->add_responsive_control( 'sub_bg_color', [
        ...
        $this->add_responsive_control( 'sub_divider_color', [
        ...
        $this->add_responsive_control( 'sub_bg_color_hover', [
        ...
        $this->add_control( 'mobile_panel_bg', [
            ...
            'selectors' => [ '{{WRAPPER}} .mh-nav-mobile-panel' => 'background-color: {{VALUE}} !important;' ],
        ] );

        $this->add_control( 'mobile_item_color', [
            'label' => 'Item Text Color', 'type' => Controls_Manager::COLOR,
            'selectors' => [ '{{WRAPPER}} .mh-nav-mobile-panel .mh-menu > li > a' => 'color: {{VALUE}} !important;' ],
        ] );
        
        $this->add_control( 'mobile_item_bg', [
            'label' => 'Item Background', 'type' => Controls_Manager::COLOR,
            'selectors' => [ '{{WRAPPER}} .mh-nav-mobile-panel .mh-menu > li > a' => 'background-color: {{VALUE}} !important;' ],
        ] );

        $this->add_control( 'mobile_item_color_hover', [
            'label' => 'Item Text Color (Hover)', 'type' => Controls_Manager::COLOR,
            'selectors' => [ '{{WRAPPER}} .mh-nav-mobile-panel .mh-menu > li > a:hover' => 'color: {{VALUE}} !important;' ],
        ] );
        
        $this->add_control( 'mobile_item_bg_hover', [
            'label' => 'Item Background (Hover)', 'type' => Controls_Manager::COLOR,
            'selectors' => [ '{{WRAPPER}} .mh-nav-mobile-panel .mh-menu > li > a:hover' => 'background-color: {{VALUE}} !important;' ],
        ] );

        $this->add_control( 'mobile_item_divider', [
            'label' => 'Item Divider Color', 'type' => Controls_Manager::COLOR,
            'selectors' => [ '{{WRAPPER}} .mh-nav-mobile-panel .mh-menu > li > a' => 'border-bottom: 1px solid {{VALUE}} !important;' ],
        ] );

        $this->add_group_control( Group_Control_Typography::get_type(), [
            'name'     => 'mobile_menu_typography',
            'selector' => '{{WRAPPER}} .mh-nav-mobile-panel .mh-menu > li > a',
        ] );
        ...
        $this->add_responsive_control( 'toggle_bg', [
    ...
    protected function render() {
        ...
        if ( $settings['enable_sticky'] === 'yes' ) {
            ...
            $css .= '.elementor-element-' . $widget_id . '.mh-sticky-active { position: sticky; top: 0; z-index: 999; transition: all 0.3s ease; }' . "\n";
        }
        ...
        <?php
        $css .= ob_get_clean();
        wp_register_style( 'mh-nav-menu-style', false );
        wp_enqueue_style( 'mh-nav-menu-style' );
        wp_add_inline_style( 'mh-nav-menu-style', $css );
        ?>
