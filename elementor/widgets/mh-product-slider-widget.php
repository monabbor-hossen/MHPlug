...
class MH_Plug_Product_Slider_Widget extends \Elementor\Widget_Base {
    ...
    public function get_title() { return __( 'MH Product Slider', 'mh-plug-ecommerce-builder-widgets' ); }
    ...
    protected function register_controls() {
        ...
        $this->add_control( 'query_type', [ 
            ...
            'default' => 'latest', 
            'options' => [ 
                'current_query' => __( 'Current Archive (Category/Tag)', 'mh-plug-ecommerce-builder-widgets' ), 
                ...
                'related_products' => __( 'Related Products (Single Product Page)', 'mh-plug-ecommerce-builder-widgets' ), 
            ], 
        ] );
        
        $this->add_control( 'posts_per_page', [ 'label' => __( 'Total Products to Load', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::NUMBER, 'default' => 8, 'min' => 1, 'max' => 50, ] );
        $this->end_controls_section();

        // ----------------------------------------------------
        // SLIDER SETTINGS
        // ----------------------------------------------------
        $this->start_controls_section( 'section_slider_settings', [ 'label' => __( 'Slider Settings', 'mh-plug-ecommerce-builder-widgets' ), 'tab' => Controls_Manager::TAB_CONTENT ] );
        ...
        $this->add_control( 'autoplay', [ 'label' => __( 'Autoplay', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::SWITCHER, 'return_value' => 'yes', 'default' => 'yes', 'separator' => 'before' ] );
        $this->add_control( 'autoplay_speed', [ 'label' => __( 'Autoplay Delay (ms)', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::NUMBER, 'default' => 3000, 'condition' => [ 'autoplay' => 'yes' ] ] );
        $this->add_control( 'pause_on_hover', [ 'label' => __( 'Pause on Hover', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::SWITCHER, 'return_value' => 'yes', 'default' => 'yes', 'condition' => [ 'autoplay' => 'yes' ] ] );
        $this->add_control( 'infinite', [ 'label' => __( 'Infinite Loop', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::SWITCHER, 'return_value' => 'yes', 'default' => 'yes' ] );
        $this->add_control( 'slider_speed', [ 'label' => __( 'Transition Speed (ms)', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::NUMBER, 'default' => 500 ] );
        $this->add_control( 'show_arrows', [ 'label' => __( 'Show Arrows', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::SWITCHER, 'return_value' => 'yes', 'default' => 'yes', 'separator' => 'before' ] );
        $this->add_control( 'show_dots', [ 'label' => __( 'Show Dots', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::SWITCHER, 'return_value' => 'yes', 'default' => 'yes' ] );
        ...
        $this->add_control( 'show_compare', [ 'label' => __( 'Show Compare Button', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::SWITCHER, 'default' => 'yes' ] );
        $this->end_controls_section();
        ...
        // ----------------------------------------------------
        $this->start_controls_section( 'section_style_card', [ 'label' => __( 'Slider Box & Card', 'mh-plug-ecommerce-builder-widgets' ), 'tab' => Controls_Manager::TAB_STYLE ] );
        ...
        $this->add_control( 'card_bg', [ 'label' => __( 'Card Background', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#ffffff', 'selectors' => [ '{{WRAPPER}} .mh-product-card' => 'background-color: {{VALUE}};' ], 'separator' => 'before' ] );
        ...
        // ----------------------------------------------------
        $this->start_controls_section( 'section_style_nav', [ 'label' => __( 'Slider Navigation', 'mh-plug-ecommerce-builder-widgets' ), 'tab' => Controls_Manager::TAB_STYLE ] );
        ...
        $this->add_control( 'arrow_color', [ 'label' => __( 'Icon Color', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#333333', 'selectors' => [ '{{WRAPPER}} .slick-arrow i' => 'color: {{VALUE}} !important;' ] ] );
        ...
        $this->add_responsive_control( 'arrow_box_size', [ 'label' => __( 'Arrow Button Size', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::SLIDER, 'range' => [ 'px' => [ 'min' => 20, 'max' => 80 ] ], 'default' => [ 'size' => 40 ], 'selectors' => [ '{{WRAPPER}} .slick-arrow' => 'width: {{SIZE}}px; height: {{SIZE}}px;' ], 'condition' => [ 'show_arrows' => 'yes' ], 'separator' => 'before' ] );
        $this->add_responsive_control( 'arrow_icon_size', [ 'label' => __( 'Arrow Icon Size', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::SLIDER, 'range' => [ 'px' => [ 'min' => 10, 'max' => 50 ] ], 'default' => [ 'size' => 16 ], 'selectors' => [ '{{WRAPPER}} .slick-arrow i' => 'font-size: {{SIZE}}px !important;' ], 'condition' => [ 'show_arrows' => 'yes' ] ] );
        ...
        $this->add_control( 'dot_color', [ 'label' => __( 'Dot Color', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#cccccc', 'selectors' => [ '{{WRAPPER}} .mh-product-slider' => '--mh-dot-color: {{VALUE}};' ], 'condition' => [ 'show_dots' => 'yes' ] ] );
        $this->add_control( 'dot_active_color', [ 'label' => __( 'Active Dot Color', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#2293e9', 'selectors' => [ '{{WRAPPER}} .mh-product-slider' => '--mh-dot-active-color: {{VALUE}};' ], 'condition' => [ 'show_dots' => 'yes' ] ] );
        ...
        $this->add_responsive_control( 'btn_width', [ 'label' => __( 'Button Width', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::SLIDER, 'default' => [ 'size' => 40 ], 'selectors' => [ $btn_target => 'width: {{SIZE}}px !important; min-width: {{SIZE}}px !important;' ] ] );
        $this->add_responsive_control( 'btn_height', [ 'label' => __( 'Button Height', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::SLIDER, 'default' => [ 'size' => 40 ], 'selectors' => [ $btn_target => 'height: {{SIZE}}px !important; min-height: {{SIZE}}px !important;' ] ] );
        ...
        $this->add_responsive_control( 'btn_radius', [ 'label' => __( 'Border Radius', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => [ 'px', '%' ], 'default' => [ 'top' => 50, 'right' => 50, 'bottom' => 50, 'left' => 50, 'unit' => '%' ], 'selectors' => [ $btn_target => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}} !important;' ] ] );

        $this->start_controls_tabs( 'tabs_btn_style' );
        $this->start_controls_tab( 'tab_btn_normal', [ 'label' => __( 'Normal', 'mh-plug-ecommerce-builder-widgets' ) ] );
        $this->add_control( 'btn_color', [ 'label' => __( 'Icon Color', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#333333', 'selectors' => [ $btn_target => 'color: {{VALUE}} !important;' ] ] );
        $this->add_control( 'btn_bg', [ 'label' => __( 'Background Color', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#ffffff', 'selectors' => [ $btn_target => 'background-color: {{VALUE}} !important;' ] ] );
        ...
        $this->add_control( 'btn_hover_color', [ 'label' => __( 'Icon Color', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#ffffff', 'selectors' => [ $btn_hover_target => 'color: {{VALUE}} !important;' ] ] );
        $this->add_control( 'btn_hover_bg', [ 'label' => __( 'Background Color', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#d63638', 'selectors' => [ $btn_hover_target => 'background-color: {{VALUE}} !important;' ] ] );
                            ...
                            <div class="mh-product-image-wrap">
                                ...
                                <div class="mh-product-actions">
                                    <?php if ( $is_product ) : ?>
                                        ...
                                        <a href="#" class="mh-action-btn mh-advanced-wishlist-btn <?php echo $in_wishlist ? 'added' : ''; ?>" data-product-id="<?php echo esc_attr($post_id); ?>" data-behavior="toggle" title="<?php esc_html_e('Wishlist', 'mh-plug-ecommerce-builder-widgets'); ?>" style="display:flex; align-items:center; justify-content:center;">
                                    ...
                                    <?php else : ?>
                                        <a href="<?php the_permalink(); ?>" class="mh-action-btn" title="<?php esc_html_e( 'Read More', 'mh-plug-ecommerce-builder-widgets' ); ?>" style="display:flex; align-items:center; justify-content:center;">
