...
class MH_Woo_Add_To_Cart_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section( 'content_section', [
            'label' => __( 'Buttons Content', 'mh-plug-ecommerce-builder-widgets' ),
            'tab'   => Controls_Manager::TAB_CONTENT,
        ] );

        $this->add_control( 'btn_text', [
            'label'   => __( 'Add to Cart Text', 'mh-plug-ecommerce-builder-widgets' ),
            'type'    => Controls_Manager::TEXT,
            'default' => __( 'Add to Cart', 'mh-plug-ecommerce-builder-widgets' ),
        ] );

        $this->add_control( 'show_buy_now', [
            'label'        => __( 'Show "Buy Now" Button', 'mh-plug-ecommerce-builder-widgets' ),
        ...
        $this->add_control( 'buy_now_text', [
            'label'     => __( 'Buy Now Text', 'mh-plug-ecommerce-builder-widgets' ),
            'type'      => Controls_Manager::TEXT,
            'default'   => __( 'Buy Now', 'mh-plug-ecommerce-builder-widgets' ),
            'condition' => [ 'show_buy_now' => 'yes' ],
        ] );

        $this->add_control( 'quantity_default', [
            'label'     => __( 'Default Quantity', 'mh-plug-ecommerce-builder-widgets' ),
        ...
        $this->add_control( 'heading_qty_icons', [
            'label'     => __( 'Quantity Icons', 'mh-plug-ecommerce-builder-widgets' ),
            'type'      => Controls_Manager::HEADING,
            'separator' => 'before',
        ] );

        $this->add_control( 'minus_icon', [
            'label'       => __( 'Minus Icon', 'mh-plug-ecommerce-builder-widgets' ),
            'type'        => Controls_Manager::ICONS,
            'default'     => [ 'value' => 'fas fa-minus', 'library' => 'fa-solid' ],
        ] );

        $this->add_control( 'plus_icon', [
            'label'       => __( 'Plus Icon', 'mh-plug-ecommerce-builder-widgets' ),
            'type'        => Controls_Manager::ICONS,
        ...
        $this->add_responsive_control( 'layout_align', [
            ...
            'options'   => [
                'flex-start' => [ 'title' => __( 'Left',   'mh-plug-ecommerce-builder-widgets' ), 'icon' => 'eicon-h-align-left' ],
                'center'     => [ 'title' => __( 'Center', 'mh-plug-ecommerce-builder-widgets' ), 'icon' => 'eicon-h-align-center' ],
                'flex-end'   => [ 'title' => __( 'Right',  'mh-plug-ecommerce-builder-widgets' ), 'icon' => 'eicon-h-align-right' ],
            ],
            'default'   => 'flex-start',
        ...
        $this->start_controls_section( 'style_btn', [ 'label' => __( 'Add to Cart Button', 'mh-plug-ecommerce-builder-widgets' ), 'tab' => Controls_Manager::TAB_STYLE ] );
        $this->add_group_control( Group_Control_Typography::get_type(), [ 'name' => 'btn_typography', 'selector' => '{{WRAPPER}} .mh-atc-btn' ] );
        $this->start_controls_tabs( 'btn_tabs' );
        $this->start_controls_tab( 'btn_normal', [ 'label' => __( 'Normal', 'mh-plug-ecommerce-builder-widgets' ) ] );
        $this->add_control( 'btn_color', [ 'label' => __( 'Text Color', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#ffffff', 'selectors' => [ '{{WRAPPER}} .mh-atc-btn' => 'color: {{VALUE}};' ] ] );
        $this->add_control( 'btn_bg', [ 'label' => __( 'Background', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#1d2327', 'selectors' => [ '{{WRAPPER}} .mh-atc-btn' => 'background-color: {{VALUE}};' ] ] );
        $this->end_controls_tab();
        $this->start_controls_tab( 'btn_hover', [ 'label' => __( 'Hover', 'mh-plug-ecommerce-builder-widgets' ) ] );
        $this->add_control( 'btn_color_hover', [ 'label' => __( 'Text Color', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#ffffff', 'selectors' => [ '{{WRAPPER}} .mh-atc-btn:hover' => 'color: {{VALUE}};' ] ] );
        $this->add_control( 'btn_bg_hover', [ 'label' => __( 'Background', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#333333', 'selectors' => [ '{{WRAPPER}} .mh-atc-btn:hover' => 'background-color: {{VALUE}};' ] ] );
        $this->end_controls_tab();
        $this->end_controls_tabs();
        $this->add_group_control( Group_Control_Border::get_type(), [ 'name' => 'btn_border', 'selector' => '{{WRAPPER}} .mh-atc-btn', 'separator' => 'before' ] );
        $this->add_control( 'btn_border_radius', [ 'label' => __( 'Border Radius', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => [ 'px', '%' ], 'default' => [ 'top' => 6, 'right' => 6, 'bottom' => 6, 'left' => 6, 'unit' => 'px' ], 'selectors' => [ '{{WRAPPER}} .mh-atc-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ] ] );
        $this->add_group_control( Group_Control_Box_Shadow::get_type(), [ 'name' => 'btn_shadow', 'selector' => '{{WRAPPER}} .mh-atc-btn' ] );
        $this->add_responsive_control( 'btn_padding', [ 'label' => __( 'Padding', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => [ 'px', 'em' ], 'default' => [ 'top' => 12, 'right' => 24, 'bottom' => 12, 'left' => 24, 'unit' => 'px' ], 'selectors' => [ '{{WRAPPER}} .mh-atc-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ], 'separator' => 'before' ] );
        $this->end_controls_section();


        /* ── STYLE: BUY NOW BUTTON ───────────────────────── */
        $this->start_controls_section( 'style_buy_now_btn', [ 'label' => __( 'Buy Now Button', 'mh-plug-ecommerce-builder-widgets' ), 'tab' => Controls_Manager::TAB_STYLE, 'condition' => [ 'show_buy_now' => 'yes' ] ] );
        ...
        $this->start_controls_tab( 'buy_now_normal', [ 'label' => __( 'Normal', 'mh-plug-ecommerce-builder-widgets' ) ] );
        $this->add_control( 'buy_now_color', [ 'label' => __( 'Text Color', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#ffffff', 'selectors' => [ '{{WRAPPER}} .mh-buy-now-btn' => 'color: {{VALUE}};' ] ] );
        $this->add_control( 'buy_now_bg', [ 'label' => __( 'Background', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#d63638', 'selectors' => [ '{{WRAPPER}} .mh-buy-now-btn' => 'background-color: {{VALUE}};' ] ] );
        $this->end_controls_tab();
        $this->start_controls_tab( 'buy_now_hover', [ 'label' => __( 'Hover', 'mh-plug-ecommerce-builder-widgets' ) ] );
        $this->add_control( 'buy_now_color_hover', [ 'label' => __( 'Text Color', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#ffffff', 'selectors' => [ '{{WRAPPER}} .mh-buy-now-btn:hover' => 'color: {{VALUE}};' ] ] );
        $this->add_control( 'buy_now_bg_hover', [ 'label' => __( 'Background', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::COLOR, 'default' => '#a82a2b', 'selectors' => [ '{{WRAPPER}} .mh-buy-now-btn:hover' => 'background-color: {{VALUE}};' ] ] );
        $this->end_controls_tab();
        $this->end_controls_tabs();
        ...
        $this->add_control( 'buy_now_border_radius', [ 'label' => __( 'Border Radius', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => [ 'px', '%' ], 'default' => [ 'top' => 6, 'right' => 6, 'bottom' => 6, 'left' => 6, 'unit' => 'px' ], 'selectors' => [ '{{WRAPPER}} .mh-buy-now-btn' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ] ] );
        $this->add_group_control( Group_Control_Box_Shadow::get_type(), [ 'name' => 'buy_now_shadow', 'selector' => '{{WRAPPER}} .mh-buy-now-btn' ] );
        $this->add_responsive_control( 'buy_now_padding', [ 'label' => __( 'Padding', 'mh-plug-ecommerce-builder-widgets' ), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => [ 'px', 'em' ], 'default' => [ 'top' => 12, 'right' => 24, 'bottom' => 12, 'left' => 24, 'unit' => 'px' ], 'selectors' => [ '{{WRAPPER}} .mh-buy-now-btn' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};' ], 'separator' => 'before' ] );
        $this->end_controls_section();


        /* ── STYLE: QUANTITY WRAPPER ─────────────────────────────── */
        $this->start_controls_section( 'style_qty_wrapper', [
            'label' => __( 'Quantity: Main Wrapper', 'mh-plug-ecommerce-builder-widgets' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );

        $this->add_responsive_control( 'qty_height', [
            'label'      => __( 'Overall Height', 'mh-plug-ecommerce-builder-widgets' ),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => [ 'px' ],
        ...
        $this->start_controls_section( 'style_qty_input', [
            'label' => __( 'Quantity: Number Input', 'mh-plug-ecommerce-builder-widgets' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );

        $this->add_responsive_control( 'qty_input_width', [
            'label'      => __( 'Input Width', 'mh-plug-ecommerce-builder-widgets' ),
            'type'       => Controls_Manager::SLIDER,
            'size_units' => [ 'px', '%' ],
        ...
        $this->start_controls_tab( 'qty_input_normal', [ 'label' => __( 'Normal', 'mh-plug-ecommerce-builder-widgets' ) ] );
        ...
        $this->start_controls_tab( 'qty_input_focus', [ 'label' => __( 'Focus', 'mh-plug-ecommerce-builder-widgets' ) ] );
        ...
        $this->start_controls_section( 'style_qty_buttons', [
            'label' => __( 'Quantity: ± Buttons', 'mh-plug-ecommerce-builder-widgets' ),
            'tab'   => Controls_Manager::TAB_STYLE,
        ] );
        ...
        $this->add_responsive_control( 'qty_btn_icon_size', [
            'label'      => __( 'Icon / Text Size', 'mh-plug-ecommerce-builder-widgets' ),
            'type'       => Controls_Manager::SLIDER,
        ...
        $this->start_controls_tab( 'qty_btn_normal', [ 'label' => __( 'Normal', 'mh-plug-ecommerce-builder-widgets' ) ] );
        $this->add_control( 'qty_btn_color', [
            'label'     => __( 'Icon / Text Color', 'mh-plug-ecommerce-builder-widgets' ),
            'type'      => Controls_Manager::COLOR,
            'default'   => '#1d2327',
        ...
        $this->start_controls_tab( 'qty_btn_hover', [ 'label' => __( 'Hover', 'mh-plug-ecommerce-builder-widgets' ) ] );
    ...
    protected function render() {
        ...
        $btn_text    = ! empty( $settings['btn_text'] ) ? $settings['btn_text'] : __( 'Add to Cart', 'mh-plug-ecommerce-builder-widgets' );
        $buy_now_text = ! empty( $settings['buy_now_text'] ) ? $settings['buy_now_text'] : __( 'Buy Now', 'mh-plug-ecommerce-builder-widgets' );
        
        $max_qty = $product->get_max_purchase_quantity();
        $max_attr = ( $max_qty > 0 ) ? 'max="' . esc_attr( $max_qty ) . '"' : '';

        // Use wc_get_page_permalink() — available much earlier in WC loading than wc_get_checkout_url().
        ...
        <div class="mh-atc-widget">
            <form class="cart mh-custom-cart-form mh-atc-form" action="<?php echo esc_url( apply_filters( 'woocommerce_add_to_cart_form_action', $product->get_permalink() ) ); ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="mh-atc-wrap">
                    ...
                    <div class="mh-qty-wrapper" role="group" aria-label="<?php esc_attr_e( 'Product quantity', 'mh-plug-ecommerce-builder-widgets' ); ?>">
                        
                        <button type="button" class="mh-qty-btn mh-qty-minus" style="display:flex; align-items:center; justify-content:center; padding:0;" aria-label="<?php esc_attr_e( 'Decrease quantity', 'mh-plug-ecommerce-builder-widgets' ); ?>">
                            <?php 
                        ...
                        <button type="button" class="mh-qty-btn mh-qty-plus" style="display:flex; align-items:center; justify-content:center; padding:0;" aria-label="<?php esc_attr_e( 'Increase quantity', 'mh-plug-ecommerce-builder-widgets' ); ?>">
                            <?php 
