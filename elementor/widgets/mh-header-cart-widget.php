...
class MH_Header_Cart_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section( 'section_layout', [ 'label' => __( 'Cart Settings', 'mh-plug' ) ] );

        $this->add_control( 'cart_type', [
            'label' => __( 'Cart Click Action', 'mh-plug' ),
            'type' => Controls_Manager::SELECT,
            'options' => [
                'redirect' => __( 'Go to Cart Page', 'mh-plug' ),
                'off-canvas' => __( 'Open Off-Canvas Mini Cart', 'mh-plug' ),
            ],
            'default' => 'off-canvas',
        ] );

        $this->add_control( 'cart_icon', [
            'label' => __( 'Cart Icon', 'mh-plug' ),
            'type' => Controls_Manager::ICONS,
            'default' => ['value' => 'fas fa-shopping-bag', 'library' => 'fa-solid'],
        ] );

        $this->add_control( 'show_badge', [
            'label' => __( 'Show Item Count Badge', 'mh-plug' ),
            'type' => Controls_Manager::SWITCHER,
            'default' => 'yes',
        ] );

        $this->add_control( 'show_floating', [
            'label' => __( 'Floating Cart Button', 'mh-plug' ),
            'type' => Controls_Manager::SWITCHER,
            'default' => '',
            'description' => __( 'Show a fixed floating cart button on the page.', 'mh-plug' ),
        ] );
        ...
        $this->start_controls_section( 'section_style_floating', [
            'label' => __( 'Floating Button', 'mh-plug' ),
            'tab' => Controls_Manager::TAB_STYLE,
        ...
        $this->add_control( 'oc_bg', [
            'label' => __( 'Panel Background', 'mh-plug' ),
            'type' => Controls_Manager::COLOR,
            'default' => '#ffffff',
        ...
        $this->add_control( 'heading_oc_header', ['label' => __( 'Header', 'mh-plug' ), 'type' => Controls_Manager::HEADING, 'separator' => 'before'] );
        ...
        $this->add_control( 'oc_header_color', [
            'label' => __( 'Header Text Color', 'mh-plug' ),
            'type' => Controls_Manager::COLOR,
        ...
        $this->add_responsive_control( 'oc_header_padding', [
            'label' => __( 'Header Padding', 'mh-plug' ),
            'type' => Controls_Manager::DIMENSIONS,
            'size_units' => ['px','em'],
        ...
        $this->add_control( 'oc_close_color', [
            'label' => __( 'Close Icon Color', 'mh-plug' ),
            'type' => Controls_Manager::COLOR,
        ...
        $this->add_control( 'heading_oc_content', ['label' => __( 'Content', 'mh-plug' ), 'type' => Controls_Manager::HEADING, 'separator' => 'before'] );
