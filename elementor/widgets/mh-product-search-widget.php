    ...
    protected function render() {
        ...
        <style>
            ...
            foreach ( $breakpoints as $bp ) {
                ...
                echo "{$prefix}-standard .mh-search-form { width: 100% !important; max-width: 100% !important; transition: none !important; background: transparent !important; }\n";
                echo "{$prefix}-standard .mh-search-input { cursor: text !important; background-color: var(--std-in-bg, #f1f1f1) !important; color: var(--std-in-c, #333333) !important; padding: var(--std-in-p, 12px 15px 12px 45px) !important; border-radius: var(--std-in-r, 4px) !important; }\n";
                ...
                echo "{$prefix}-expandable .mh-search-trigger { display: flex !important; color: var(--exp-tr-c, #333333) !important; fill: var(--exp-tr-c, #333333) !important; background-color: var(--exp-tr-bg, transparent) !important; padding: var(--exp-tr-p, 10px) !important; border-radius: var(--exp-tr-r, 4px) !important; }\n";
                ...
                echo "{$prefix}-expandable .mh-search-input { cursor: text !important; background-color: var(--exp-in-bg, #f1f1f1) !important; color: var(--exp-in-c, #333333) !important; padding: var(--exp-in-p, 12px 15px 12px 45px) !important; }\n";
                ...
                echo "{$prefix}-slide_out.mh-search-is-open .mh-search-form { width: 100% !important; max-width: var(--mor-box-w, 320px) !important; background-color: var(--mor-in-bg, #ffffff) !important; border-radius: var(--mor-in-r, 50px) !important; }\n";
