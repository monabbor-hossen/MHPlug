 ...
 * Fully Responsive, Isolated CSS Variables, Pixel-Perfect Alignments, Grouped Controls, and Advanced Positioning.
 */
...
class MH_Plug_Product_Search_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->add_group_control( Group_Control_Border::get_type(), [
            'name'      => 'std_border',
            'selector'  => '{{WRAPPER}} .mh-desk-standard .mh-search-input',
            'separator' => 'before',
        ] );
        ...
        $this->add_responsive_control( 'exp_box_pos_x', [
            ...
            'selectors'  => [ '{{WRAPPER}}' => '--exp-pos-x: {{SIZE}}{{UNIT}};' ],
        ] );
        ...
        $this->add_responsive_control( 'mor_trig_pad', [ 
            ...
            'size_units' => [ 'px', 'em', '%' ],
            'selectors'  => [ 
                '{{WRAPPER}}' => '--mor-tr-p: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}}; --mor-tr-pl: {{LEFT}}{{UNIT}}; --mor-tr-pr: {{RIGHT}}{{UNIT}};' 
            ] 
        ] );
        ...
        $this->add_responsive_control( 'icon_left_pos', [
            ...
            'default'    => [ 'size' => 15, 'unit' => 'px' ],
            'selectors'  => [ '{{WRAPPER}}' => '--ic-l: {{SIZE}}{{UNIT}};' ],
        ] );
    ...
    protected function render() {
        ...
        $css = "
            ...
            /* Base Reset Styles */
            .mh-search-trigger { border: none; cursor: pointer; display: flex; align-items: center; justify-content: center; transition: all 0.3s ease; padding: 10px; z-index: 10; }
            ...
            .mh-search-icon { 
                ...
                left: var(--ic-l, 15px); 
                top: 50%; 
                transform: translateY(calc(-50% + var(--ic-nudge-y, 0px))); 
        ...
        foreach ( $breakpoints as $bp ) {
            ...
            // 1. STANDARD LAYOUT
            $css .= "{$prefix}-standard .mh-search-trigger { display: none !important; }\n";
            ...
            $css .= "{$prefix}-standard.mh-live-search-wrapper { justify-content: center !important; }\n";
            $css .= "{$prefix}-standard .mh-search-form { width: 100% !important; max-width: 100% !important; transition: none !important; background: transparent !important; }\n";
            $css .= "{$prefix}-standard .mh-search-input { cursor: text !important; background-color: var(--std-in-bg, #f1f1f1) !important; color: var(--std-in-c, #333333) !important; padding: var(--std-in-p, 12px 15px 12px 45px) !important; border-radius: var(--std-in-r, 4px) !important; }\n";
            $css .= "{$prefix}-standard .mh-search-input::placeholder { color: var(--std-ph-c, #888888) !important; opacity: 1 !important; }\n";
            
            $css .= "{$prefix}-standard .mh-search-icon { left: var(--ic-l, 15px) !important; top: 50% !important; transform: translateY(calc(-50% + var(--ic-nudge-y, 0px))) !important; }\n";
            $css .= "{$prefix}-standard .mh-search-icon i, {$prefix}-standard .mh-search-icon svg, {$prefix}-standard .mh-search-spinner i { color: var(--std-ic-c, #888888) !important; fill: var(--std-ic-c, #888888) !important; font-size: var(--std-ic-s, 16px) !important; width: var(--std-ic-s, 16px) !important; height: var(--std-ic-s, 16px) !important; }\n";
            ...
            $css .= "{$prefix}-expandable .mh-search-trigger { display: flex !important; color: var(--exp-tr-c, #333333) !important; fill: var(--exp-tr-c, #333333) !important; background-color: var(--exp-tr-bg, transparent) !important; padding: var(--exp-tr-p, 10px) !important; border-radius: var(--exp-tr-r, 4px) !important; }\n";
            $css .= "{$prefix}-expandable .mh-search-trigger:hover { color: var(--exp-tr-hc, #d63638) !important; fill: var(--exp-tr-hc, #d63638) !important; background-color: var(--exp-tr-hbg, transparent) !important; }\n";
            $css .= "{$prefix}-expandable .mh-search-trigger i, {$prefix}-expandable .mh-search-trigger svg { font-size: var(--exp-tr-s, 20px) !important; width: var(--exp-tr-s, 20px) !important; height: var(--exp-tr-s, 20px) !important; }\n";
            
            $css .= "{$prefix}-expandable .mh-search-expandable-container { position: absolute !important; top: calc(100% + var(--exp-pos-y, 15px)) !important; right: calc(0px - var(--exp-pos-x, 0px)) !important; opacity: 0 !important; visibility: hidden !important; transform: translateY(10px) !important; background-color: var(--exp-box-bg, #ffffff) !important; padding: var(--exp-box-p, 15px) !important; max-width: 90vw !important; width: var(--exp-box-w, 320px) !important; z-index: 9999 !important; display: block; }\n";
            
            $css .= "{$prefix}-expandable.mh-search-is-open .mh-search-expandable-container { opacity: 1 !important; visibility: visible !important; transform: translateY(0) !important; }\n";
            $css .= "{$prefix}-expandable.mh-live-search-wrapper { justify-content: flex-end !important; }\n";
            $css .= "{$prefix}-expandable .mh-search-form { width: 100% !important; max-width: 100% !important; transition: none !important; background: transparent !important; border: none !important; }\n";
            $css .= "{$prefix}-expandable .mh-search-input { cursor: text !important; background-color: var(--exp-in-bg, #f1f1f1) !important; color: var(--exp-in-c, #333333) !important; padding: var(--exp-in-p, 12px 15px 12px 45px) !important; }\n";
            $css .= "{$prefix}-expandable .mh-search-input::placeholder { color: var(--exp-ph-c, #888888) !important; opacity: 1 !important; }\n";
            
            $css .= "{$prefix}-expandable.mh-design-modern .mh-search-icon { display: flex !important; left: var(--ic-l, 15px) !important; top: 50% !important; transform: translateY(calc(-50% + var(--ic-nudge-y, 0px))) !important; }\n";
            $css .= "{$prefix}-expandable .mh-search-icon i, {$prefix}-expandable .mh-search-icon svg, {$prefix}-expandable .mh-search-spinner i { color: var(--exp-ic-c, #888888) !important; fill: var(--exp-ic-c, #888888) !important; font-size: var(--exp-ic-s, 16px) !important; width: var(--exp-ic-s, 16px) !important; height: var(--exp-ic-s, 16px) !important; display: block !important; }\n";
            
            $css .= "{$prefix}-expandable .mh-search-results { position: static !important; box-shadow: none !important; border-top: 1px solid #eee !important; margin-top: 10px !important; padding-top: 10px !important; border: none !important; max-height: 400px !important; overflow-y: auto !important; display: none; }\n";

            // 3. MORPHING SLIDER 
            $css .= "{$prefix}-slide_out .mh-search-trigger { display: none !important; }\n";
            $css .= "{$prefix}-slide_out .mh-search-expandable-container { position: relative !important; top: auto !important; right: auto !important; opacity: 1 !important; visibility: visible !important; transform: none !important; background: transparent !important; padding: 0 !important; border-radius: 0 !important; box-shadow: none !important; max-width: 100% !important; width: 100% !important; z-index: 1 !important; display: flex; justify-content: flex-end; align-items: center !important; }\n";
            
            $css .= "{$prefix}-slide_out .mh-search-form { display: flex !important; align-items: center !important; justify-content: flex-end !important; width: auto !important; max-width: 100% !important; transition: all 0.4s cubic-bezier(0.25, 0.8, 0.25, 1) !important; margin-left: auto !important; background-color: var(--mor-tr-bg, #f1f1f1) !important; border-radius: var(--mor-tr-r, 50px) !important; position: relative; overflow: hidden !important; }\n";
            
            $css .= "{$prefix}-slide_out .mh-search-icon { display: flex !important; align-items: center !important; justify-content: center !important; position: relative !important; top: auto !important; transform: none !important; left: auto !important; padding: var(--mor-tr-p, 15px) !important; color: var(--mor-tr-c, #333333) !important; fill: var(--mor-tr-c, #333333) !important; pointer-events: none !important; transition: all 0.4s ease !important; z-index: 2; height: auto !important; width: auto !important; line-height: 1 !important; }\n";
            
            $css .= "{$prefix}-slide_out .mh-search-icon i, {$prefix}-slide_out .mh-search-icon svg { font-size: var(--mor-tr-s, 20px) !important; width: var(--mor-tr-s, 20px) !important; height: var(--mor-tr-s, 20px) !important; display: block !important; flex-shrink: 0 !important; }\n";
            
            $css .= "{$prefix}-slide_out .mh-search-input { position: absolute !important; top: 0; left: 0; width: 100% !important; height: 100% !important; opacity: 0 !important; cursor: pointer !important; padding: 0 !important; margin: 0 !important; border: none !important; z-index: 10; background: transparent !important; }\n";
            
            $css .= "{$prefix}-slide_out.mh-live-search-wrapper { justify-content: flex-end !important; }\n";
            
            $css .= "{$prefix}-slide_out.mh-live-search-wrapper:not(.mh-search-is-open) .mh-search-form:hover { background-color: var(--mor-tr-hbg, #e1e1e1) !important; }\n";
            $css .= "{$prefix}-slide_out.mh-live-search-wrapper:not(.mh-search-is-open) .mh-search-form:hover .mh-search-icon { color: var(--mor-tr-hc, #d63638) !important; fill: var(--mor-tr-hc, #d63638) !important; }\n";
            
            $css .= "{$prefix}-slide_out.mh-search-is-open .mh-search-form { width: 100% !important; max-width: var(--mor-box-w, 320px) !important; background-color: var(--mor-in-bg, #ffffff) !important; border-radius: var(--mor-in-r, 50px) !important; }\n";
            
            $css .= "{$prefix}-slide_out.mh-search-is-open .mh-search-icon { position: absolute !important; left: var(--ic-l, 15px) !important; top: 50% !important; transform: translateY(calc(-50% + var(--ic-nudge-y, 0px))) !important; padding: 0 !important; width: auto !important; height: auto !important; color: var(--mor-ic-c, #888888) !important; fill: var(--mor-ic-c, #888888) !important; }\n";
            
            $css .= "{$prefix}-slide_out.mh-search-is-open .mh-search-icon i, {$prefix}-slide_out.mh-search-is-open .mh-search-icon svg, {$prefix}-slide_out.mh-search-is-open .mh-search-spinner i { font-size: var(--mor-ic-s, var(--mor-tr-s, 20px)) !important; width: var(--mor-ic-s, var(--mor-tr-s, 20px)) !important; height: var(--mor-ic-s, var(--mor-tr-s, 20px)) !important; }\n";
            
            $css .= "{$prefix}-slide_out.mh-search-is-open .mh-search-input { position: relative !important; opacity: 1 !important; cursor: text !important; color: var(--mor-in-c, #333333) !important; padding: var(--mor-in-p, 12px 15px 12px 45px) !important; line-height: normal !important; }\n";
            $css .= "{$prefix}-slide_out.mh-search-is-open .mh-search-input::placeholder { color: var(--mor-ph-c, #888888) !important; opacity: 1 !important; }\n";
            
            $css .= "{$prefix}-slide_out .mh-search-results { position: absolute !important; top: calc(100% + 5px) !important; right: 0 !important; left: auto !important; width: var(--mor-box-w, 320px) !important; z-index: 99999 !important; border-radius: 4px !important; box-shadow: 0 10px 20px rgba(0,0,0,0.08) !important; border: 1px solid #eee !important; margin: 0 !important; padding: 0 !important; max-height: 400px !important; overflow-y: auto !important; display: none; }\n";
            
            $css .= "}\n";
        }
        wp_register_style( 'mh-product-search-style', false );
        wp_enqueue_style( 'mh-product-search-style' );
        wp_add_inline_style( 'mh-product-search-style', $css );
        ?>
        ...
        $js = "
            jQuery(document).ready(function($) {
                ...
                var searchTimer;
                var notFoundText = '" . esc_js( $not_found ) . "';

                $('.mh-search-trigger, .mh-search-input').on('click focus', function(e) {
