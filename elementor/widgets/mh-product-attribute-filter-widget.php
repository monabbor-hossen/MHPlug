...
class MH_Product_Attribute_Filter_Widget extends \Elementor\Widget_Base {
    ...
    protected function register_controls() {
        ...
        $this->start_controls_section( 'section_filter_settings', [
            'label' => __( 'Filter Sections', 'mh-plug-ecommerce-builder-widgets' ),
        ]);

        $this->add_control('show_search', [ 'label' => __('Search', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::SWITCHER, 'default' => 'yes' ]);
        $this->add_control('show_categories', [ 'label' => __('Categories', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::SWITCHER, 'default' => 'yes' ]);
        $this->add_control('show_price', [ 'label' => __('Price Range', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::SWITCHER, 'default' => 'yes' ]);
        $this->add_control('show_brands', [ 'label' => __('Brands', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::SWITCHER, 'default' => 'yes' ]);
        $this->add_control('show_status', [ 'label' => __('Status (Sale / Featured)', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::SWITCHER, 'default' => 'yes' ]);
        $this->add_control('show_rating', [ 'label' => __('Rating', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::SWITCHER, 'default' => 'yes' ]);
        ...
        $this->add_control('selected_attributes', [
            'label' => __('Attributes to Show', 'mh-plug-ecommerce-builder-widgets'),
        ...
        $this->add_control('target_grid_id', [
            'label' => __('Target Grid CSS ID', 'mh-plug-ecommerce-builder-widgets'),
            'type' => Controls_Manager::TEXT,
            'default' => '',
            'description' => __('Optional. CSS ID of the MH Product Grid to update. Leave empty to target the first grid on the page.', 'mh-plug-ecommerce-builder-widgets'),
        ]);

        $this->add_control('show_reset', [ 'label' => __('Reset Button', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::SWITCHER, 'default' => 'yes' ]);

        $this->add_control('reset_text', [
            'label' => __('Button Text', 'mh-plug-ecommerce-builder-widgets'),
            'type' => Controls_Manager::TEXT,
            'default' => __('Reset All Filters', 'mh-plug-ecommerce-builder-widgets'),
        ...
        // ── STYLE: GENERAL ──
        $this->start_controls_section( 'section_style_general', [ 'label' => __( 'General', 'mh-plug-ecommerce-builder-widgets' ), 'tab' => Controls_Manager::TAB_STYLE ]);
        $this->add_control('widget_bg', [ 'label' => __('Background', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-widget' => 'background: {{VALUE}};'] ]);
        $this->add_responsive_control('widget_padding', [ 'label' => __('Padding', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => ['px','em'], 'selectors' => ['{{WRAPPER}} .mhaf-widget' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'] ]);
        $this->add_responsive_control('widget_radius', [ 'label' => __('Border Radius', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => ['px','%'], 'selectors' => ['{{WRAPPER}} .mhaf-widget' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'] ]);
        ...
        $this->add_responsive_control('section_spacing', [ 'label' => __('Section Spacing', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::SLIDER, 'range' => ['px' => ['min' => 0, 'max' => 60]], 'default' => ['size' => 20], 'selectors' => ['{{WRAPPER}} .mhaf-section' => 'margin-bottom: {{SIZE}}px; padding-bottom: {{SIZE}}px;'] ]);
        $this->add_control('divider_color', [ 'label' => __('Section Divider Color', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'default' => '#eee', 'selectors' => ['{{WRAPPER}} .mhaf-section' => 'border-bottom-color: {{VALUE}};'] ]);
        $this->end_controls_section();

        // ── STYLE: HEADINGS ──
        $this->start_controls_section( 'section_style_headings', [ 'label' => __( 'Section Headings', 'mh-plug-ecommerce-builder-widgets' ), 'tab' => Controls_Manager::TAB_STYLE ]);
        $this->add_group_control(Group_Control_Typography::get_type(), [ 'name' => 'heading_typo', 'selector' => '{{WRAPPER}} .mhaf-heading' ]);
        $this->add_control('heading_color', [ 'label' => __('Color', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-heading' => 'color: {{VALUE}};'] ]);
        $this->add_responsive_control('heading_margin', [ 'label' => __('Bottom Spacing', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::SLIDER, 'range' => ['px' => ['min' => 0, 'max' => 30]], 'selectors' => ['{{WRAPPER}} .mhaf-heading' => 'margin-bottom: {{SIZE}}px;'] ]);
        $this->end_controls_section();

        // ── STYLE: SEARCH INPUT ──
        $this->start_controls_section( 'section_style_search', [ 'label' => __( 'Search Input', 'mh-plug-ecommerce-builder-widgets' ), 'tab' => Controls_Manager::TAB_STYLE ]);
        $this->add_group_control(Group_Control_Typography::get_type(), [ 'name' => 'search_typo', 'selector' => '{{WRAPPER}} .mhaf-search' ]);
        $this->add_control('search_color', [ 'label' => __('Text Color', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-search' => 'color: {{VALUE}};'] ]);
        $this->add_control('search_bg', [ 'label' => __('Background', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-search' => 'background: {{VALUE}};'] ]);
        $this->add_control('search_border_color', [ 'label' => __('Border Color', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-search' => 'border-color: {{VALUE}};'] ]);
        $this->add_control('search_focus_color', [ 'label' => __('Focus Border Color', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-search:focus' => 'border-color: {{VALUE}};'] ]);
        $this->add_responsive_control('search_padding', [ 'label' => __('Padding', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => ['px'], 'selectors' => ['{{WRAPPER}} .mhaf-search' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'] ]);
        $this->add_responsive_control('search_radius', [ 'label' => __('Border Radius', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => ['px'], 'selectors' => ['{{WRAPPER}} .mhaf-search' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'] ]);
        $this->end_controls_section();

        // ── STYLE: CHECKBOXES & LABELS ──
        $this->start_controls_section( 'section_style_checkbox', [ 'label' => __( 'Checkbox & Labels', 'mh-plug-ecommerce-builder-widgets' ), 'tab' => Controls_Manager::TAB_STYLE ]);
        $this->add_group_control(Group_Control_Typography::get_type(), [ 'name' => 'label_typo', 'selector' => '{{WRAPPER}} .mhaf-label' ]);
        $this->add_control('label_color', [ 'label' => __('Label Color', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-label' => 'color: {{VALUE}};'] ]);
        $this->add_control('count_color', [ 'label' => __('Count Color', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-count' => 'color: {{VALUE}};'] ]);
        $this->add_control('checkbox_border_color', [ 'label' => __('Checkbox Border', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-mark' => 'border-color: {{VALUE}};'] ]);
        $this->add_control('accent_color', [ 'label' => __('Active/Checked Color', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'default' => '#004265', 'selectors' => [
        ...
        $this->add_responsive_control('checkbox_size', [ 'label' => __('Checkbox Size', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::SLIDER, 'range' => ['px' => ['min' => 12, 'max' => 28]], 'selectors' => ['{{WRAPPER}} .mhaf-mark' => 'width: {{SIZE}}px; height: {{SIZE}}px;'] ]);
        $this->add_responsive_control('item_spacing', [ 'label' => __('Item Spacing', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::SLIDER, 'range' => ['px' => ['min' => 0, 'max' => 20]], 'selectors' => ['{{WRAPPER}} .mhaf-item' => 'margin-bottom: {{SIZE}}px;'] ]);
        $this->end_controls_section();

        // ── STYLE: PRICE RANGE ──
        $this->start_controls_section( 'section_style_price', [ 'label' => __( 'Price Range', 'mh-plug-ecommerce-builder-widgets' ), 'tab' => Controls_Manager::TAB_STYLE ]);
        $this->add_control('price_track_bg', [ 'label' => __('Track Background', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'default' => '#e0e0e0', 'selectors' => ['{{WRAPPER}} .mhaf-range-bar' => 'background: {{VALUE}};'] ]);
        $this->add_control('price_track_active', [ 'label' => __('Active Track Color', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-range-track' => 'background: {{VALUE}};'] ]);
        $this->add_control('price_handle_bg', [ 'label' => __('Handle Background', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-range-handle' => 'background: {{VALUE}};'] ]);
        $this->add_responsive_control('price_handle_size', [ 'label' => __('Handle Size', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::SLIDER, 'range' => ['px' => ['min' => 12, 'max' => 28]], 'selectors' => ['{{WRAPPER}} .mhaf-range-handle' => 'width: {{SIZE}}px; height: {{SIZE}}px;'] ]);
        $this->add_responsive_control('price_track_height', [ 'label' => __('Track Height', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::SLIDER, 'range' => ['px' => ['min' => 2, 'max' => 12]], 'selectors' => ['{{WRAPPER}} .mhaf-range-bar' => 'height: {{SIZE}}px;'] ]);
        $this->add_control('price_input_border', [ 'label' => __('Input Border Color', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-price-inputs input' => 'border-color: {{VALUE}};'] ]);
        $this->end_controls_section();

        // ── STYLE: ATTRIBUTE SWATCHES ──
        $this->start_controls_section( 'section_style_swatches', [ 'label' => __( 'Attribute Swatches', 'mh-plug-ecommerce-builder-widgets' ), 'tab' => Controls_Manager::TAB_STYLE ]);
        $this->add_control('swatch_bg', [ 'label' => __('Background', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-swatch:not(.color-type)' => 'background: {{VALUE}};'] ]);
        $this->add_control('swatch_color', [ 'label' => __('Text Color', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-swatch:not(.color-type)' => 'color: {{VALUE}};'] ]);
        $this->add_control('swatch_border_color', [ 'label' => __('Border Color', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-swatch' => 'border-color: {{VALUE}};'] ]);
        $this->add_control('swatch_active_bg', [ 'label' => __('Active Background', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-swatch.active:not(.color-type)' => 'background: {{VALUE}};'] ]);
        $this->add_responsive_control('swatch_padding', [ 'label' => __('Padding', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => ['px'], 'selectors' => ['{{WRAPPER}} .mhaf-swatch:not(.color-type)' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'] ]);
        $this->add_responsive_control('swatch_radius', [ 'label' => __('Border Radius', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => ['px','%'], 'selectors' => ['{{WRAPPER}} .mhaf-swatch:not(.color-type)' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'] ]);
        $this->add_responsive_control('color_swatch_size', [ 'label' => __('Color Swatch Size', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::SLIDER, 'range' => ['px' => ['min' => 18, 'max' => 50]], 'selectors' => ['{{WRAPPER}} .mhaf-swatch.color-type' => 'width: {{SIZE}}px; height: {{SIZE}}px;'] ]);
        $this->add_responsive_control('swatch_gap', [ 'label' => __('Gap', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::SLIDER, 'range' => ['px' => ['min' => 2, 'max' => 20]], 'selectors' => ['{{WRAPPER}} .mhaf-swatches' => 'gap: {{SIZE}}px;'] ]);
        $this->end_controls_section();

        // ── STYLE: STATUS TAGS ──
        $this->start_controls_section( 'section_style_tags', [ 'label' => __( 'Status Tags', 'mh-plug-ecommerce-builder-widgets' ), 'tab' => Controls_Manager::TAB_STYLE ]);
        $this->add_group_control(Group_Control_Typography::get_type(), [ 'name' => 'tag_typo', 'selector' => '{{WRAPPER}} .mhaf-tag' ]);
        $this->add_control('tag_color', [ 'label' => __('Text Color', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-tag' => 'color: {{VALUE}};'] ]);
        $this->add_control('tag_bg', [ 'label' => __('Background', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-tag' => 'background: {{VALUE}};'] ]);
        $this->add_control('tag_border_color', [ 'label' => __('Border Color', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-tag' => 'border-color: {{VALUE}};'] ]);
        $this->add_control('tag_active_color', [ 'label' => __('Active Text', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'selectors' => ['{{WRAPPER}} .mhaf-tag.active' => 'color: {{VALUE}};'] ]);
        $this->add_responsive_control('tag_padding', [ 'label' => __('Padding', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => ['px'], 'selectors' => ['{{WRAPPER}} .mhaf-tag' => 'padding: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'] ]);
        $this->add_responsive_control('tag_radius', [ 'label' => __('Border Radius', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::DIMENSIONS, 'size_units' => ['px'], 'selectors' => ['{{WRAPPER}} .mhaf-tag' => 'border-radius: {{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'] ]);
        $this->end_controls_section();

        // ── STYLE: RATING STARS ──
        $this->start_controls_section( 'section_style_stars', [ 'label' => __( 'Rating Stars', 'mh-plug-ecommerce-builder-widgets' ), 'tab' => Controls_Manager::TAB_STYLE ]);
        $this->add_control('star_color', [ 'label' => __('Star Color', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'default' => '#ffb800', 'selectors' => ['{{WRAPPER}} .mhaf-stars' => 'color: {{VALUE}};'] ]);
        $this->add_control('star_empty_color', [ 'label' => __('Empty Star Color', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::COLOR, 'default' => '#ddd', 'selectors' => ['{{WRAPPER}} .mhaf-stars .empty' => 'color: {{VALUE}};'] ]);
        $this->add_responsive_control('star_size', [ 'label' => __('Star Size', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::SLIDER, 'range' => ['px' => ['min' => 10, 'max' => 24]], 'selectors' => ['{{WRAPPER}} .mhaf-stars' => 'font-size: {{SIZE}}px;'] ]);
        $this->end_controls_section();

        // ── STYLE: RESET BUTTON ──
        $this->start_controls_section( 'section_style_reset', [
            'label' => __( 'Reset Button', 'mh-plug-ecommerce-builder-widgets' ),
        ...
        $this->add_responsive_control('reset_width', [
            ...
            'default' => 'full',
            'options' => [
                'auto' => __('Auto (Fit Content)', 'mh-plug-ecommerce-builder-widgets'),
                'full' => __('Full Width', 'mh-plug-ecommerce-builder-widgets'),
            ],
        ...
        $this->start_controls_tab('tab_reset_normal', ['label' => __('Normal','mh-plug-ecommerce-builder-widgets')]);
        $this->add_control('reset_color', ['label'=>__('Text Color','mh-plug-ecommerce-builder-widgets'),'type'=>Controls_Manager::COLOR,'default'=>'#ffffff','selectors'=>['{{WRAPPER}} .mhaf-reset'=>'color:{{VALUE}};']]);
        $this->add_control('reset_bg', ['label'=>__('Background','mh-plug-ecommerce-builder-widgets'),'type'=>Controls_Manager::COLOR,'default'=>'#e74c3c','selectors'=>['{{WRAPPER}} .mhaf-reset'=>'background-color:{{VALUE}};']]);
        $this->add_control('reset_icon_color', ['label'=>__('Icon Color','mh-plug-ecommerce-builder-widgets'),'type'=>Controls_Manager::COLOR,'selectors'=>['{{WRAPPER}} .mhaf-reset .mhaf-reset-icon'=>'color:{{VALUE}};fill:{{VALUE}};']]);
        ...
        $this->start_controls_tab('tab_reset_hover', ['label' => __('Hover','mh-plug-ecommerce-builder-widgets')]);
        $this->add_control('reset_hover_color', ['label'=>__('Text Color','mh-plug-ecommerce-builder-widgets'),'type'=>Controls_Manager::COLOR,'default'=>'#ffffff','selectors'=>['{{WRAPPER}} .mhaf-reset:hover'=>'color:{{VALUE}};']]);
        $this->add_control('reset_hover_bg', ['label'=>__('Background','mh-plug-ecommerce-builder-widgets'),'type'=>Controls_Manager::COLOR,'default'=>'#c0392b','selectors'=>['{{WRAPPER}} .mhaf-reset:hover'=>'background-color:{{VALUE}};']]);
        $this->add_control('reset_hover_icon_color', ['label'=>__('Icon Color','mh-plug-ecommerce-builder-widgets'),'type'=>Controls_Manager::COLOR,'selectors'=>['{{WRAPPER}} .mhaf-reset:hover .mhaf-reset-icon'=>'color:{{VALUE}};fill:{{VALUE}};']]);
        ...
        $this->add_control('reset_transition', [
            'label' => __('Hover Transition (s)', 'mh-plug-ecommerce-builder-widgets'),
            'type' => Controls_Manager::SLIDER,
        ...
        $this->start_controls_section( 'section_style_mobile', [
            'label' => __( 'Mobile Floating Button', 'mh-plug-ecommerce-builder-widgets' ),
            'tab' => Controls_Manager::TAB_STYLE,
        ]);

        $this->add_control('mobile_breakpoint', [
            'label' => __('Mobile Breakpoint (px)', 'mh-plug-ecommerce-builder-widgets'),
            'type' => Controls_Manager::NUMBER,
            'default' => 767,
            'description' => __('Below this width, filter hides and floating button appears.', 'mh-plug-ecommerce-builder-widgets'),
        ]);
        ...
        $this->add_control('fab_text', [
            'label' => __('Button Text', 'mh-plug-ecommerce-builder-widgets'),
            'type' => Controls_Manager::TEXT,
            'default' => __('Filters', 'mh-plug-ecommerce-builder-widgets'),
        ]);

        $this->start_controls_tabs('tabs_fab_style');

        $this->start_controls_tab('tab_fab_normal', ['label' => __('Normal', 'mh-plug-ecommerce-builder-widgets')]);
        ...
        $this->start_controls_tab('tab_fab_hover', ['label' => __('Hover', 'mh-plug-ecommerce-builder-widgets')]);
        ...
        $this->add_control('heading_sidebar_style', ['label' => __('Sidebar Panel', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::HEADING, 'separator' => 'before']);

        $this->add_control('sidebar_bg', [
            'label' => __('Sidebar Background', 'mh-plug-ecommerce-builder-widgets'),
            'type' => Controls_Manager::COLOR,
            'default' => '#ffffff',
            'selectors' => ['{{WRAPPER}} .mhaf-sidebar-panel' => 'background-color:{{VALUE}};'],
        ]);

        $this->add_control('heading_sidebar_header_style', ['label' => __('Sidebar Header & Close', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::HEADING, 'separator' => 'before']);
        ...
        $this->add_control('sidebar_header_color', [
            'label' => __('Header Title Color', 'mh-plug-ecommerce-builder-widgets'),
            'type' => Controls_Manager::COLOR,
            'default' => '#ffffff',
        ...
        $this->start_controls_tab('tab_close_normal', ['label' => __('Normal', 'mh-plug-ecommerce-builder-widgets')]);
        ...
        $this->start_controls_tab('tab_close_hover', ['label' => __('Hover', 'mh-plug-ecommerce-builder-widgets')]);
        ...
        $this->add_responsive_control('close_radius', [
            'label' => __('Close Border Radius', 'mh-plug-ecommerce-builder-widgets'),
            'type' => Controls_Manager::DIMENSIONS,
            'size_units' => ['px','%'],
            'selectors' => ['{{WRAPPER}} .mhaf-sidebar-close' => 'border-radius:{{TOP}}{{UNIT}} {{RIGHT}}{{UNIT}} {{BOTTOM}}{{UNIT}} {{LEFT}}{{UNIT}};'],
        ]);

        $this->add_control('heading_sidebar_layout', ['label' => __('Sidebar Layout', 'mh-plug-ecommerce-builder-widgets'), 'type' => Controls_Manager::HEADING, 'separator' => 'before']);

        $this->add_responsive_control('sidebar_width', [
            'label' => __('Sidebar Width', 'mh-plug-ecommerce-builder-widgets'),
            'type' => Controls_Manager::SLIDER,
            'size_units' => ['px','%','vw'],
    ...
    protected function render() {
        ...
        <div class="mhaf-widget mhaf-desktop-filter mhaf-desktop-filter-<?php echo $wid; ?>" id="mhaf-<?php echo $wid; ?>" data-target="<?php echo $target; ?>">
            ...
            <div class="mhaf-section">
                <div class="mhaf-heading"><?php esc_html_e('Search', 'mh-plug-ecommerce-builder-widgets'); ?></div>
                <input type="text" class="mhaf-search" data-filter="mh_search" placeholder="<?php esc_attr_e('Search products...', 'mh-plug-ecommerce-builder-widgets'); ?>">
            </div>
            <?php endif; ?>
            ...
            <div class="mhaf-section">
                <div class="mhaf-heading"><?php esc_html_e('Category', 'mh-plug-ecommerce-builder-widgets'); ?></div>
            ...
            <div class="mhaf-section">
                <div class="mhaf-heading"><?php esc_html_e('Brand', 'mh-plug-ecommerce-builder-widgets'); ?></div>
            ...
            <div class="mhaf-section">
                <div class="mhaf-heading"><?php esc_html_e('Status', 'mh-plug-ecommerce-builder-widgets'); ?></div>
                <div class="mhaf-tags">
                    <span class="mhaf-tag" data-filter="mh_status" data-value="featured"><?php esc_html_e('Featured', 'mh-plug-ecommerce-builder-widgets'); ?></span>
                    <span class="mhaf-tag" data-filter="mh_status" data-value="onsale"><?php esc_html_e('On Sale', 'mh-plug-ecommerce-builder-widgets'); ?></span>
                </div>
            </div>
            <?php endif; ?>
            ...
            <?php if ($s['show_reset'] === 'yes'):
                $reset_text = !empty($s['reset_text']) ? $s['reset_text'] : __('Reset All Filters', 'mh-plug-ecommerce-builder-widgets');
